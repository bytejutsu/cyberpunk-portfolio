...
import TechnologiesBanner from "@/components/TechnologiesSection/TechnologiesBanner";
import CyberNeonText from "@/components/cyberpunk/CyberNeonText/CyberNeonText";
import GlitchText from "@/components/cyberpunk/GlitchText/GlitchText";
                    ...
                    <div className="flex flex-wrap items-center">
                        <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                            ...
                            <h3 className="text-3xl text-white mb-2 font-semibold leading-normal font-mono">
                                <GlitchText text="Dedicated Team" className="text-2xl sm:text-3xl md:text-4xl font-bold" />
                            </h3>
